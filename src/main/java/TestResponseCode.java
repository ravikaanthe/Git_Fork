...
public class TestResponseCode
{
    public static void main(String[] args)
    {
        ...
        // easy to understand
        String url = "http:drldev.xcubelabs.com/test";
    ...
    private static void DownloadPage(String url)
    {
        ...
        try
        {
        	System.setProperty("webdriver.chrome.driver", "/Users/janardhan/Desktop/Senzit_FMP/FMP_Automation/BrowserDrivers/Mac/chromedriver");
